...
Bubbles = function() {
  ...
  updateLabels = function() {
    ...
    label.style("font-size", function(d) {
      return Math.max(8, rScale(rValue(d) / 2)) - 8 + "px";
...
/* $(function() {
  ...
  return d3.csv("/static/data/" + text.file, display);
}); */

var area = ['Zhongshan.csv','Zhongzheng.csv','SongShan.csv','Wen-Shan.csv',
'Daan.csv','Datong.csv','BigShiLin.csv','BigPeitou.csv',
'Wanhua.csv','HsinYi.csv','Nangang.csv',
'Neihu.csv'];

var path_root = '/static/data/'
